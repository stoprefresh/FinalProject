...
START TRANSACTION;
USE `qrxdb`;
INSERT INTO `user` (`id`, `username`, `password`, `active`, `role`, `create_date`, `title`, `first_name`, `middle_name`, `last_name`, `email`, `phone`, `street`, `city`, `state`, `zip`) VALUES (1, 'dmaunit23', 'test', 1, 'ems', '2019-08-14 11:27:52', NULL, 'John', 'C', 'Smith', 'jcsmith@dma.org', '303-555-5155', '123 Java Rd', 'Denver', NULL, '80111');
INSERT INTO `user` (`id`, `username`, `password`, `active`, `role`, `create_date`, `title`, `first_name`, `middle_name`, `last_name`, `email`, `phone`, `street`, `city`, `state`, `zip`) VALUES (2, 'jldoe', 'test', 1, 'patient', '2019-08-15 09:27:52', NULL, 'Jane', 'Lindsey', 'Doe', 'jldoe@doe.com', '303-555-5155', '8072 Angular Rd', 'Englewood', NULL, '80110');
INSERT INTO `user` (`id`, `username`, `password`, `active`, `role`, `create_date`, `title`, `first_name`, `middle_name`, `last_name`, `email`, `phone`, `street`, `city`, `state`, `zip`) VALUES (3, 'admin', 'test', 1, 'admin', '2019-08-14 05:27:52', NULL, 'QRXAdmin', 'Admin', 'Admin', 'admin@qrx.com', '303-555-5155', '9070 Spring Tool Street', 'Englewood', NULL, '80110');
INSERT INTO `user` (`id`, `username`, `password`, `active`, `role`, `create_date`, `title`, `first_name`, `middle_name`, `last_name`, `email`, `phone`, `street`, `city`, `state`, `zip`) VALUES (4, 'ksmith1', 'test', 1, 'physician', '2019-08-14 05:27:52', 'MD', 'Kevin', 'W', 'Smith', 'kws@group.com', '303-555-5155', '4032 Bit drive', 'Denver', NULL, '80111');
