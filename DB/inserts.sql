...
START TRANSACTION;
USE `qrxdb`;
INSERT INTO `user` (`id`, `username`, `password`, `active`, `role`, `create_date`, `title`, `first_name`, `middle_name`, `last_name`, `email`, `phone`, `street`, `city`, `state`, `zip`, `image`) VALUES (1, 'jsmith1', '$2a$10$4SMKDcs9jT18dbFxqtIqDeLEynC7MUrCEUbv1a/bhO.x9an9WGPvm', 1, 'EMS', '2019-08-14 11:27:52', NULL, 'John', 'C', 'Smith', 'jcsmith@dma.org', '303-555-5155', 'Static Main Rd', 'Denver', 'CO', '80111', '/../assets/img/kevin.jpg');
INSERT INTO `user` (`id`, `username`, `password`, `active`, `role`, `create_date`, `title`, `first_name`, `middle_name`, `last_name`, `email`, `phone`, `street`, `city`, `state`, `zip`, `image`) VALUES (2, 'jldoe', '$2a$10$4SMKDcs9jT18dbFxqtIqDeLEynC7MUrCEUbv1a/bhO.x9an9WGPvm', 1, 'User', '2019-08-15 09:27:52', NULL, 'Jane', 'Lindsey', 'Doe', 'jldoe@doe.com', '303-555-5155', '8072 Angular Rd', 'Englewood', 'CO', '80110', '/../assets/img/jane.jpg');
INSERT INTO `user` (`id`, `username`, `password`, `active`, `role`, `create_date`, `title`, `first_name`, `middle_name`, `last_name`, `email`, `phone`, `street`, `city`, `state`, `zip`, `image`) VALUES (3, 'admin', '$2a$10$4SMKDcs9jT18dbFxqtIqDeLEynC7MUrCEUbv1a/bhO.x9an9WGPvm', 1, 'Admin', '2019-08-14 05:27:52', NULL, 'QRXAdmin', 'Admin', 'Admin', 'admin@qrx.com', '303-555-5155', '9070 Spring Tool Street', 'Englewood', 'CO', '80110', '/../assets/img/admin.jpg');
INSERT INTO `user` (`id`, `username`, `password`, `active`, `role`, `create_date`, `title`, `first_name`, `middle_name`, `last_name`, `email`, `phone`, `street`, `city`, `state`, `zip`, `image`) VALUES (4, 'ksmith1', '$2a$10$4SMKDcs9jT18dbFxqtIqDeLEynC7MUrCEUbv1a/bhO.x9an9WGPvm', 1, 'Physician', '2019-08-14 05:27:52', 'MD', 'Kevin', 'W', 'Smith', 'kws@group.com', '303-555-5155', '4032 Bit drive', 'Denver', 'CO', '80111', '/../assets/img/john.jpg');
