...
START TRANSACTION;
USE `qrxdb`;
INSERT INTO `user` (`id`, `username`, `password`, `active`, `role`, `create_date`, `title`, `first_name`, `middle_name`, `last_name`, `email`, `phone`, `street`, `city`, `state`, `zip`) VALUES (1, 'dmaunit23', '$2a$10$4SMKDcs9jT18dbFxqtIqDeLEynC7MUrCEUbv1a/bhO.x9an9WGPvm', 1, 'ems', '2019-08-14 11:27:52', NULL, 'John', 'C', 'Smith', 'jcsmith@dma.org', '303-555-5155', 'Static Main Rd', 'Denver', 'CO', '80111');
